...
import com.deerwalk.HSPParser.Utils.CSVGenerator;
import com.deerwalk.HSPParser.Utils.FileReader;
import com.deerwalk.HSPParser.Utils.HSPLayoutReader;
import com.deerwalk.HSPParser.Utils.IOUtils;
...
public class HSPReaderV1 implements HSPReader {
    ...
    public static Logger logger = Logger.getLogger(HSPReaderV1.class);
    ...
    public void setFooter(String footerMessage) {
        System.out.println(":::::: footer Message ::::"+footerMessage);
    }
    ...
    public void parseInputFile(String inputFile, LayoutExtractor layoutExtractor, RuleExtractor ruleExtractor) {
        ...
        while (fileReaderScanner.hasNextLine()) {
            ...
            if ((contentSegment.equalsIgnoreCase(Constants.Insured_Begin_Segment)
                 ...
                 * ***/
                if (previousLayoutType !=null && previousLayoutType.equalsIgnoreCase(Constants.Layout_DEPENDENT)
